  ...
  return (
    <div className="relative w-full min-h-screen px-4 sm:px-8 md:px-20 mx-auto mt-20 rounded-lg overflow-hidden flex flex-col justify-center items-center">
      ...
      >
        ...
        {isRTL && (
          <div className="w-full lg:w-2/3 flex flex-col items-center justify-center mt-4 lg:mt-0">
            ...
            {/* Navigation buttons for RTL in small and medium screens - Positioned directly below slides */}
            <div className="flex gap-2 mt-4 justify-center lg:hidden">
              <button
                onClick={prevSlide}
                className="w-8 h-8 rounded-full bg-emerald-400 border-none flex items-center justify-center"
                aria-label={t("promo.previousSlide")}
              >
                <svg
        ...
        {!isRTL && (
          <div className="w-full lg:w-2/3 flex flex-col items-center justify-center mt-4 lg:mt-0 lg:ml-8">
            <div className="flex gap-2">
              {/* Main active slide */}
              <div className="w-48 md:w-56 rounded-lg overflow-hidden shadow-lg bg-white">
                <div className="relative h-96 md:h-[70vh]">
            ...
            {/* Navigation buttons for LTR in small and medium screens - positioned below slides */}
            <div className="flex gap-2 mt-4 justify-center lg:hidden">
              <button
                onClick={prevSlide}
                className="w-8 h-8 rounded-full bg-emerald-400 border-none flex items-center justify-center"
      ...
      {/* Navigation buttons for large screens only - positioned at the bottom of the container */}
