  ...
  return (
    <div className="relative bg-[#121212] min-h-screen md:min-h-0 h-auto lg:h-screen pt-12 px-4 md:px-8 lg:px-12">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-8 md:py-12 lg:py-0">
        ...
        <div className="w-full lg:w-1/2 text-white p-8 relative overflow-hidden">
          {/* Main content */}
...
//       <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-8 md:py-12 lg:py-0">
//         {/* Left Column - Text Content */}
//         <div className="w-full lg:w-1/2 mb-12 lg:mb-0 pr-0 lg:pr-4">
//           <div className="relative">
//             {/* Icon elements */}
//             <div className="absolute -top-4 left-5 hidden md:block">
//               <Image
//                 src="/icons/cam.svg"
//                 alt=""
//                 width={24}
...
//             {/* Subheading */}
//             <h2 className="text-lg md:text-xl lg:text-2xl text-white font-medium mt-2">
//               Monetize your creativity
//             </h2>

//             {/* Description */}
//             <p className="text-gray-300 text-sm md:text-base lg:text-lg mt-4 max-w-lg">
//               Welcome to the Pick Side! Where social meets shopping, and trust
//               takes center stage. Pick isn&apos;t just an app - it&apos;s a
//               community-powered platform where creativity thrives and trust
//               fuels every interaction.
