...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className="bg-gray-900 text-white py-8 sm:py-10 px-4 sm:px-8 border-b-2 border-blue-500 relative"
      dir={isRTL ? "rtl" : "ltr"}
    >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start mb-8 md:mb-12">
          ...
          <div className="w-full md:w-auto mb-8 md:mb-0 flex flex-col items-center md:items-start">
            ...
            <div className="mb-5 relative w-32 h-12">
              <Image
                src="/images/logo.svg"
                alt={isRTL ? t("footer.logoAlt") : "PICK Logo"}
                width={128}
                height={48}
            ...
            >
              {isRTL ? t("footer.contactUs") : "Contact with us"}
            </Link>
          ...
          <div className="flex flex-col items-center md:items-end space-y-2 w-full md:w-auto">
            ...
            >
              {isRTL ? t("footer.privacyPolicy") : "Privacy Policy"}
            </Link>
            ...
            <Link
              ...
              className="text-sm text-white hover:text-gray-300 transition-colors"
            >
              {isRTL ? t("footer.termsConditions") : "Terms & Conditions"}
            </Link>
          </div>
        </div>
