...
const AppPromoComponent: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen px-4 sm:px-8 md:px-20 mx-auto mt-20 rounded-lg overflow-hidden flex flex-col justify-center items-center">
      ...
      {/* Main content - Stacked on small/medium screens, side by side on large */}
      <div className="flex flex-col lg:flex-row p-4 md:p-12 items-center justify-center gap-4 md:gap-8 relative z-10 max-w-5xl w-full">
        {/* Text Content - Centered on small/medium, left aligned on large */}
        <div className="w-full lg:w-1/3 space-y-4 md:space-y-6 mb-6 lg:mb-0 text-center lg:text-left">
          ...
          {/* Download Buttons - Stacked and centered on small/medium, row on large */}
          <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row gap-4 justify-center lg:justify-start md:max-w-xs mx-auto lg:max-w-none lg:mx-0">
            {/* iOS Download Button */}
            <Link
              href="#ios-download"
        ...
        {/* App Screenshots - Below on small/medium screens, right side on large */}
        <div className="w-full lg:w-2/3 flex justify-center mt-4 lg:mt-0">
          <div className="flex space-x-2">
            {/* Main active slide - responsive height adjustments */}
